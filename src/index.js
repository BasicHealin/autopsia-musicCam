...
const createParticles = () => {
    ...
    for (let y = 0, height = imageData.height; y < height; y += 60) {
        for (let x = 0, width = imageData.width; x < width; x += 60) {
...
const draw = (t) => {
    ...
    // video
    if (particles) {
        particles.material.color.r = 9 - r;
        particles.material.color.g = 9 - g;
        particles.material.color.b = 9 - b;
